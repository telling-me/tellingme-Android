...
import com.tellingus.tellingme.provider.NavigationProvider
...
fun TellingMeScreen(
    ...
    val bottomNavNotIncludeList = listOf(TellingMeScreenRoute.RECORD.route, TellingMeScreenRoute.ALARM.route)
